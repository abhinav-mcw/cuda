...
__global__ void conv3dGPU(float *d_A, float *d_B, float *d_C, int height, int width, int channel, int mask_height, int mask_width, int mask_channel, int output_height, int output_width, int num_masks)
{
...
int main()
{
    ...
    float *d_a, *d_b, *d_c;
    // Matrix sizes
    int height = 5, width = 5, channel = 8;
    int mask_width = 3, mask_height = 3, mask_channel = 8, num_masks = 8;
